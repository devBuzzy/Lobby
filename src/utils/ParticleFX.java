...
public enum ParticleFX
{
  ...
  private static final Map<String, ParticleFX> NAME_MAP;
  ...
  private ParticleFX(String name)
  {
    this.name = name;
  }
  ...
  public static ParticleFX fromName(String name)
  {
    if (name != null) {
      for (Map.Entry<String, ParticleFX> e : NAME_MAP.entrySet()) {
        if (((String)e.getKey()).equalsIgnoreCase(name)) {
          return (ParticleFX)e.getValue();
        }
      }
    }
    return null;
